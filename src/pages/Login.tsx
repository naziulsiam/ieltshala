...
import { GraduationCap, Mail, Lock, Loader2, AlertCircle, Clock } from "lucide-react";
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (rateLimitMsg) {
        ...
        setError(`Rate limit reached. Supabase free tier allows only 5-10 login attempts per hour.\n\n${rateLimitMsg}`);
      } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-secondary/30 px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm mt-1">Continue your IELTS preparation</p>
        </div>
