import { Flame, Clock, TrendingUp, Bell, Calendar, CreditCard, ChevronRight, Trophy, BookOpen, Zap, Target, Star, Award, Lock } from "lucide-react";
  ...
  <div className="p-4 md:p-6 max-w-[960px] mx-auto space-y-6">
    ...
    <div className="bg-card rounded-xl p-5 shadow-card flex items-center gap-4">
      ...
      <div className="flex-1 min-w-0">
        <h1 className="text-xl font-bold leading-tight">Rahima K.</h1>
        <p className="text-xs text-muted-foreground">rahima@example.com</p>
        <div className="flex items-center gap-4 mt-1.5 text-xs">
          <span className="flex items-center gap-1 text-accent font-semibold">
            <Flame className="w-3.5 h-3.5" /> 12-day streak
          </span>
          <span className="flex items-center gap-1 text-muted-foreground">
            <Clock className="w-3.5 h-3.5" /> 48h practice
          </span>
        </div>
      </div>
    </div>
